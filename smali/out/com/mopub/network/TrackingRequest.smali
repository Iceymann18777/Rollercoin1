...
.method public static makeVastTrackingTwoHttpRequest(Ljava/util/List;Lcom/mopub/mobileads/VastErrorCode;Ljava/lang/Integer;Ljava/lang/String;Landroid/content/Context;)V
    .registers 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v1, Lcom/mopub/mobileads/VastTrackerTwo;
    ...
    .line 120
    :cond_1f
    invoke-virtual {v1}, Lcom/mopub/mobileads/VastTrackerTwo;->isTracked()Z

    move-result v2

    if-eqz v2, :cond_2c

    invoke-virtual {v1}, Lcom/mopub/mobileads/VastTrackerTwo;->isRepeatable()Z
    ...
    .line 123
    :cond_2c
    invoke-virtual {v1}, Lcom/mopub/mobileads/VastTrackerTwo;->getContent()Ljava/lang/String;
    ...
    .line 124
    invoke-virtual {v1}, Lcom/mopub/mobileads/VastTrackerTwo;->setTracked()V
